...
* Creati o actiune noua numita "filter" in controller-ul songs si afisati sub ce forma preferati:
** Cantecele care dureaza mai mult de 140 de secunde
** Cantecele dintre anii 1970 si 1995
** Playlist-urile pentru winamp
** Cantecele care sunt cantate in Winamp
** Cantecele ai caror autori au anul mai mare de 1985
** Autorii care au in nume "Author" 

Referinte:
* http://guides.rubyonrails.org/
* http://stackoverflow.com/questions/9192130/like-clause-with-rails-3-and-sqlite
